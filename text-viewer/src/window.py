...
class TextViewerWindow(Adw.ApplicationWindow):
    ...
    def open_file_dialog(self, action, parameters):
    ...
    def on_open_response(self, dialog, response):
        ...
        # Release the file selection box reference
        self._native = None
    ...
    def save_file(self, file):
        ...
        # Get all visible text between the start and end iterators
        text = buffer.get_text(start, end, False)

        if not text: # Then, return early
            return
